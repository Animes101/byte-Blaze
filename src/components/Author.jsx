...
const Author = () => {
  ...
  return (
    <div>
      <div className="flex flex-col justify-center p-6 shadow-xl shadow-gray-400 rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
      ...
      <div className="space-y-4 text-center divide-y dark:divide-gray-300">
        <div className="my-2 space-y-1">
          ...
          <p className="px-5 text-xs sm:text-base dark:text-gray-600">{title}</p>
        </div>
